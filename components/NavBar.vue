<template>
  <nav class="w-full p-6 bg-white navbar" >
      ...
      <div class="flex items-center justify-between">
        ...
        <div class="hidden md:block">
          <ul class="flex space-x-8 text-sm font-sans">
            ...
            <a href="mailto:contact.rightlab@gmail.com">Contact</a>
          </ul>
        </div>
        ...
        <aside class="p-5 transform top-0 left-0 w-64 bg-white fixed h-full overflow-auto ease-in-out transition-all duration-300 z-30" :class="isOpen ? 'translate-x-0' : '-translate-x-full'">
          ...
          <ul class="divide-y font-sans">
            <NuxtLink to="team" class="my-4 inline-block">Home</NuxtLink>
            <NuxtLink to="team" class="my-4 inline-block">Team</NuxtLink>
            <NuxtLink to="publications" class="my-4 inline-block">Publications</NuxtLink>
            <a href="mailto:contact.rightlab@gmail.com" class="my-4 inline-block">Contact</a>
          </ul>
